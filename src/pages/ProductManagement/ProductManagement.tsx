    ...
    <div className="container mx-auto p-4">
      ...
      <div>
        <Table>
          ...
          <TableHeader>
            <TableRow className="">
              <TableHead className="w-[100px] text-primary font-bold">Image</TableHead>
              <TableHead className="text-primary font-bold">Name</TableHead>
              <TableHead className="text-primary font-bold">Price</TableHead>
              <TableHead className="text-right text-primary font-bold">Category</TableHead>
              <TableHead className="text-right text-primary font-bold">Quantity</TableHead>
